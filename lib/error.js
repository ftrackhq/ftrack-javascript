 ...
 * @memberof error
 */
var ServerPermissionDeniedError = (exports.ServerPermissionDeniedError =
  errorFactory("ServerPermissionDeniedError"));
 ...
 * @memberof error
 */
var ServerValidationError = (exports.ServerValidationError = errorFactory(
 ...
 * @memberof error
 */
var EventServerReplyTimeoutError = (exports.EventServerReplyTimeoutError =
  errorFactory("EventServerReplyTimeoutError"));
 ...
 * @memberof error
 */
var EventServerConnectionTimeoutError =
  (exports.EventServerConnectionTimeoutError = errorFactory(
 ...
 * @memberof error
 */
var CreateComponentError = (exports.CreateComponentError = errorFactory(
  "CreateComponentError"
));

var AbortError = (exports.AbortError = errorFactory("AbortError"));
