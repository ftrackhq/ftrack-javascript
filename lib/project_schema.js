...
function getStatuses(session, projectSchemaId, entityType) {
    ...
    // unrelated things.
    var groupedAttributes = [['_task_workflow.statuses.name', '_task_workflow.statuses.color', '_task_workflow.statuses.sort'], ['_version_workflow.statuses.name', '_version_workflow.statuses.color', '_version_workflow.statuses.sort'], ['_overrides.type_id', '_overrides.workflow_schema.statuses.name', '_overrides.workflow_schema.statuses.sort', '_overrides.workflow_schema.statuses.color'], ['_schemas.type_id', '_schemas.statuses.task_status.name', '_schemas.statuses.task_status.color', '_schemas.statuses.task_status.sort']];
