...
var Session = exports.Session = function () {
    ...
    _createClass(Session, [{
        ...
        key: 'call',
        value: function call(operations, abortController) {
            var _this6 = this;
        ...
        key: 'query',
        value: function query(expression, abortController) {
        ...
        key: 'search',
        value: function search(_ref4, abortController) {
            var expression = _ref4.expression,
                entityType = _ref4.entityType,
                _ref4$terms = _ref4.terms,
                terms = _ref4$terms === undefined ? [] : _ref4$terms,
                contextId = _ref4.contextId,
                objectTypeIds = _ref4.objectTypeIds;
        ...
        value: function thumbnailUrl(componentId) {
            var _ref5 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
                ...
                size = _ref5$size === undefined ? 300 : _ref5$size;
