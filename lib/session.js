...
var Session = exports.Session = function () {
     ...
     * @param  {string} [options.clientToken=null] - Client token for update events.
    ...
    function Session(serverUrl, apiUser, apiKey) {
        ...
        var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
            ...
            _ref$operationMetadat = _ref.operationMetadata,
            operationMetadata = _ref$operationMetadat === undefined ? null : _ref$operationMetadat;
        ...
        */
            ...
            if (this.operationMetadata) {
                operations.forEach(function (operation) {
                    if (['create', 'update', 'query'].includes(operation.action)) {
                        operation.metadata = Object.assign({}, _this6.operationMetadata, operation.metadata);
                    }
                });
            }
        ...
        value: function call(operations) {
            ...
            var request = new Promise(function (resolve) {
                if (_this7.initializing && !_this7.initialized) {
                    _this7.initializing.then(function () {
                        resolve();
                    });
                } else {
                    resolve();
            ...
            request = request.then(function () {
                return fetch(url, {
                    ...
                    headers: {
                        ...
                        'ftrack-api-key': _this7.apiKey,
                        'ftrack-user': _this7.apiUser,
                        'ftrack-Clienttoken': _this7.clientToken
                    },
                    body: _this7.encodeOperations(operations)
                });
            });
            ...
            request = request.then(function (response) {
                if (response.exception) {
                    return Promise.reject(_this7.getErrorFromResponse(response));
                }
        ...
        */
        ...
        value: function ensure(entityType, data) {
            ...
            return this.query(expression).then(function (response) {
                if (response.data.length === 0) {
                    return _this8.create(entityType, data).then(function (_ref2) {
                ...
                if (updated) {
                    return _this8.update(entityType, primaryKeys.map(function (key) {
        ...
        value: function createComponent(file) {
            ...
            request = request.then(function () {
                ...
                return _this9.call([(0, _operation.createOperation)('FileComponent', component), (0, _operation.createOperation)('ComponentLocation', componentLocation)]);
            });
