...
var Session = exports.Session = function () {
    ...
    _createClass(Session, [{
        ...
        value: function createComponent(file) {
            ...
            var onProgressCallback = options.onProgressCallback || defaultProgress;
            ...
            var componentLocationId = _uuid2.default.v4();
            var url = void 0;
            var headers = void 0;
            var aborted = void 0;
            ...
            var createComponentAndLocationPromise = request.then(function (response) {
                url = response[0].url;
            ...
            createComponentAndLocationPromise.then(function () {
                logger.debug('Uploading file to: ' + url);

                xhr.upload.addEventListener('progress', updateOnProgressCallback);
                xhr.open('PUT', url, true);
                xhr.onabort = function () {
                    return _this8.call([(0, _operation.deleteOperation)('FileComponent', [componentId]), (0, _operation.deleteOperation)('ComponentLocation', [componentLocationId])]);
                };
