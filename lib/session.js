...
var Session = (exports.Session = (function () {
  ...
  function Session(serverUrl, apiUser, apiKey) {
    ...
    var _ref =
      ...
      autoConnectEventHub =
        _ref$autoConnectEvent === undefined ? false : _ref$autoConnectEvent,
      _ref$serverInformatio = _ref.serverInformationValues,
      serverInformationValues =
        _ref$serverInformatio === undefined ? null : _ref$serverInformatio,
      _ref$eventHubOptions = _ref.eventHubOptions,
      eventHubOptions =
        _ref$eventHubOptions === undefined ? {} : _ref$eventHubOptions,
     ...
     * @type {EventHub}
     */
    this.eventHub = new _event_hub2.default(
      serverUrl,
      apiUser,
      apiKey,
      eventHubOptions
  ...
  _createClass(Session, [
    ...
    },
    {
      ...
      value: function getIdentifyingKey(entity) {
        ...
        if (primaryKeys) {
          return [entity.__entity_type__]
            .concat(
              _toConsumableArray(
                primaryKeys.map(function (attribute) {
    ...
    },
    {
      ...
      value: function ensure(entityType, data) {
        ...
        var expression =
          "select " + primaryKeys.join(", ") + " from " + entityType + " where";
    ...
    },
    {
      ...
      value: function search(_ref6) {
        var expression = _ref6.expression,
          ...
          terms = _ref6$terms === undefined ? [] : _ref6$terms,
    ...
    },
    {
      ...
      value: function update(type, keys, data) {
        ...
        var request = this.call([
          (0, _operation.updateOperation)(type, keys, data),
        ]);
        request = request.then(function (responses) {
          var response = responses[0];
          return response;
    ...
    },
    {
      ...
      value: function getComponentUrl(componentId) {
        ...
        return (
          this.serverUrl +
          "/component/get?" +
          (0, _encode_uri_parameters2.default)(params)
        );
      },
    ...
    },
    {
      ...
      value: function thumbnailUrl(componentId) {
        var _ref8 =
          ...
          size = _ref8$size === undefined ? 300 : _ref8$size;
    ...
    },
    {
      ...
      value: function createComponent(file) {
        ...
        var updateOnProgressCallback = function updateOnProgressCallback(
          oEvent
        ) {
        ...
        var componentAndLocationPromise = request.then(function (response) {
          ...
          return _this8.call([
            (0, _operation.createOperation)("FileComponent", component),
            (0, _operation.createOperation)(
              "ComponentLocation",
              componentLocation
            ),
          ]);
        ...
        return componentAndLocationPromise.then(function () {
          ...
          return new Promise(function (resolve, reject) {
            ...
            xhr.onabort = function () {
              ...
              _this8
                .call([
                  (0, _operation.deleteOperation)("FileComponent", [
                    componentId,
                  ]),
                  (0, _operation.deleteOperation)("ComponentLocation", [
                    componentLocationId,
                  ]),
                ])
                .then(function () {
                  reject(
                    new _error.CreateComponentError(
