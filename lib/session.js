...
var Session = exports.Session = function () {
  ...
  _createClass(Session, [{
    ...
    value: function createComponent(file) {
      ...
      var componentAndLocationPromise = this.call([(0, _operation.createOperation)("FileComponent", component), (0, _operation.createOperation)("ComponentLocation", componentLocation), {
      ...
      return componentAndLocationPromise.then(function () {
        ...
        return new Promise(function (resolve, reject) {
          ...
          xhr.onabort = function () {
            onAborted();
            _this8.delete("FileComponent", [componentId]).then(function () {
