...
var EventHub = exports.EventHub = function () {
    ...
    _createClass(EventHub, [{
        ...
        value: function publish(event) {
            ...
            if (reply) {
                var onReply = new Promise(function (resolve, reject) {
                    _this._replyCallbacks[event.getData().id] = resolve;
        ...
        value: function getSubscriberByIdentifier(identifier) {
            ...
            try {
                for (var _iterator2 = this._subscribers.slice()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        value: function _handle(event) {
            ...
            try {
                for (var _iterator3 = this._subscribers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
