...
var EventHub = (exports.EventHub = (function () {
  ...
  function EventHub(serverUrl, apiUser, apiKey) {
    var _ref =
      ...
      applicationId =
        _ref$applicationId === undefined
          ? "ftrack.api.javascript"
          : _ref$applicationId;
    ...
    if (serverUrl.match(portRegex)) {
      ...
      var port = serverUrl.lastIndexOf("https", 0) === 0 ? "443" : "80";
  ...
  _createClass(EventHub, [
    {
      ...
      value: function connect() {
        this._socketIo = _socket2.default.connect(this._serverUrl, {
          ...
          query: (0, _encode_uri_parameters2.default)({
    ...
    },
    {
      ...
      value: function _onSocketConnected() {
        ...
        try {
          for (
            var _iterator = this._subscribers[Symbol.iterator](), _step;
        ...
        if (callbacks.length) {
          this._unsentEvents = [];
          this.logger.debug(
            "Publishing " + callbacks.length + " unsent events."
          );
          ...
          try {
            for (
              var _iterator2 = callbacks[Symbol.iterator](), _step2;
    ...
    },
    {
      ...
      value: function publish(event) {
        ...
        var _ref2 =
          ...
          onReply = _ref2$onReply === undefined ? null : _ref2$onReply,
          _ref2$timeout = _ref2.timeout,
          timeout = _ref2$timeout === undefined ? 10 : _ref2$timeout;
        ...
        var onConnected = new Promise(function (resolve, reject) {
          ...
          if (timeout) {
            setTimeout(function () {
              var error = new _error.EventServerConnectionTimeoutError(
    ...
    },
    {
      ...
      value: function publishAndWaitForReply(event, _ref3) {
        ...
        var _ref3$timeout = _ref3.timeout,
          timeout = _ref3$timeout === undefined ? 30 : _ref3$timeout;
        ...
        var response = new Promise(function (resolve, reject) {
          ...
          if (timeout) {
            setTimeout(function () {
              var error = new _error.EventServerReplyTimeoutError(
    ...
    },
    {
      ...
      value: function _addSubscriber(subscription, callback) {
        ...
        if (existingSubscriber) {
          throw new _error.NotUniqueError(
    ...
    },
    {
      ...
      value: function getSubscriberByIdentifier(identifier) {
        ...
        try {
          for (
            var _iterator3 = this._subscribers.slice()[Symbol.iterator](),
              _step3;
    ...
    },
    {
      ...
      value: function _handle(event) {
        ...
        try {
          for (
            var _iterator4 = this._subscribers[Symbol.iterator](), _step4;
